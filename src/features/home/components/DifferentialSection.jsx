                    ...
                    <div className="relative">
                        <div className="relative z-10 rounded-[3rem] overflow-hidden">
                            <img
                                ...
                                alt="Calidad Sueño Dorado"
                                className="w-full aspect-[4/5] object-cover"
                            />
                        </div>
                        {/* Floating elements for "Differential" feel */}
                        <div className="absolute -top-10 -right-10 w-40 h-40 bg-gold-500 rounded-full flex items-center justify-center animate-pulse-slow p-8 text-center text-white font-display font-black text-xs uppercase tracking-widest leading-tight">
                            Hecho en Perú
                        </div>
                        <div className="absolute -bottom-10 -left-10 w-64 h-64 border-2 border-gold-500/20 rounded-full -z-10 bg-gold-50/50 dark:bg-gold-900/10 blur-[60px]"></div>
                    </div>

                    {/* Content Side */}
                    <div className="space-y-12">
                        <div className="space-y-6">
                            <span className="text-gold-500 text-xs font-black tracking-[0.4em] uppercase block">
                                Nuestra Filosofía
                            </span>
                            <h2 className="text-4xl lg:text-6xl font-display font-black text-gray-900 dark:text-white leading-[1.1] uppercase tracking-tighter">
                                Diseñados para <br />
                                <span className="text-gold-500">Descansar</span>, <br />
                                no solo para vender.
                            </h2>
                            <p className="text-gray-500 dark:text-gray-400 text-lg lg:text-xl font-medium leading-relaxed max-w-lg">
                                En Sueño Dorado no fabricamos volúmenes infinitos, creamos piezas de descanso pensadas en el bienestar real del cuerpo.
                            </p>
                        </div>
