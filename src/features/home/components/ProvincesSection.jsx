...
const ProvincesSection = () => {
  ...
  return (
    <section className="py-24 md:py-40 dark:bg-[#050505] relative overflow-hidden transition-colors duration-1000">
      ...
      <EngineeringGrid color="#299C47" opacity="0.03" size="120px" />
