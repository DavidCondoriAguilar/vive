...
export const BRAND_NAME = import.meta.env.VITE_BRAND_NAME || 'Vive';
export const API_URL = import.meta.env.VITE_API_URL || 'http://localhost:3000/api';
export const PRODUCTION_URL = import.meta.env.VITE_PRODUCTION_URL || 'https://vive.pe';
...
export const getWhatsAppLink = (message = '') => {
    const encodedMessage = encodeURIComponent(
        message || `Hola ${BRAND_NAME}, me gustaría recibir asesoría estratégica para transformar mi descanso con su tecnología.`
    );
