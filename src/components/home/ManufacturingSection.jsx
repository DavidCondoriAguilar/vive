...
const ManufacturingSection = () => {
  ...
  return (
    <section className="py-24 bg-white dark:bg-gray-950 relative overflow-hidden transition-colors duration-700">
      ...
      <div className="absolute bottom-0 left-0 w-[500px] h-[500px] bg-vive-500/5 rounded-full blur-[120px] translate-y-1/2 -translate-x-1/2"></div>
      ...
      <div className="container mx-auto px-6 lg:px-20 relative z-10">
        ...
        <div className="flex flex-col md:flex-row items-end justify-between mb-16 gap-8">
          <div className="max-w-2xl">
            <span className="text-vive-500 font-black text-[10px] uppercase tracking-[0.4em] mb-4 block">Ingeniería del Descanso</span>
            <h2 className="text-4xl md:text-6xl font-black text-gray-900 dark:text-white uppercase leading-[0.9] tracking-tighter">
              Control Total,<br /> <span className="text-vive-500 italic font-light">Desde el Origen</span>
            </h2>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-6 h-auto">
          ...
          <div className="md:col-span-12 lg:col-span-7 bg-gray-900 rounded-[3rem] p-10 flex flex-col justify-between relative overflow-hidden group border border-white/5">
            <div className="absolute top-0 right-0 w-80 h-80 bg-vive-500/10 rounded-full blur-[100px] -translate-y-1/2 translate-x-1/2"></div>

            <div className="relative z-10">
              <div className="flex items-center gap-4 mb-8">
                <div className="w-16 h-16 rounded-2xl bg-white/5 border border-white/10 flex items-center justify-center text-vive-500">
                  <FaAward className="w-8 h-8" />
                </div>
                <div>
                  <div className="text-white font-black text-3xl tracking-tighter">+30 Años</div>
                  <div className="text-vive-500/60 text-[10px] uppercase tracking-widest font-bold">Trayectoria Imbatible</div>
                </div>
              </div>
              <h3 className="text-3xl md:text-5xl font-black text-white mb-6 uppercase tracking-tight leading-none">
                Liderando la industria <br /> <span className="text-vive-500">en todo el Perú</span>
              </h3>
            </div>
            ...
            <div className="relative z-10 mt-12">
              <div className="grid grid-cols-3 gap-4">
                ...
                <div className="bg-vive-500 rounded-2xl p-6 text-center shadow-xl shadow-vive-500/20">
          ...
          <div className="md:col-span-6 lg:col-span-5 bg-vive-500 rounded-[3rem] p-10 flex flex-col items-center justify-center text-center relative overflow-hidden group shadow-2xl shadow-vive-500/10">
          ...
          <div className="md:col-span-6 lg:col-span-4 bg-gray-50 dark:bg-white/5 rounded-[2.5rem] p-8 border border-gray-100 dark:border-white/5 hover:border-vive-500/30 transition-all duration-500 group">
            <div className="w-14 h-14 rounded-2xl bg-white dark:bg-black shadow-sm flex items-center justify-center text-vive-500 mb-6 group-hover:scale-110 transition-transform">
          ...
          <div className="md:col-span-12 lg:col-span-8 bg-gray-50 dark:bg-white/5 rounded-[2.5rem] p-8 border border-gray-100 dark:border-white/5 hover:border-vive-500/30 transition-all duration-500 group overflow-hidden relative">
            <div className="flex flex-col md:flex-row items-center gap-10 relative z-10">
              <div className="w-20 h-20 rounded-full bg-vive-500 flex items-center justify-center text-black flex-shrink-0 shadow-lg">
