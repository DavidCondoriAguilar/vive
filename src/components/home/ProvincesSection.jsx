...
const ProvincesSection = () => {
  ...
  return (
    <section className="py-24 bg-white dark:bg-gray-950 relative overflow-hidden transition-colors duration-700">
      ...
      <div className="absolute top-0 left-0 w-[600px] h-[600px] bg-vive-500/[0.03] rounded-full blur-[120px] -translate-x-1/2 -translate-y-1/2"></div>
      <div className="absolute bottom-0 right-0 w-[600px] h-[600px] bg-vive-500/[0.02] rounded-full blur-[120px] translate-x-1/2 translate-y-1/2"></div>
      ...
      <div className="container mx-auto px-6 lg:px-20 relative z-10">
        ...
        <div className="flex flex-col md:flex-row items-end justify-between mb-20 gap-8">
          <div className="max-w-2xl">
            <span className="text-vive-500 font-black text-[10px] uppercase tracking-[0.4em] mb-4 block">Logística Nacional</span>
            <h2 className="text-4xl md:text-7xl font-black text-gray-900 dark:text-white uppercase leading-[0.85] tracking-tighter">
              Despachamos a <br /> <span className="text-vive-500 italic font-light">todo el Perú</span>
            </h2>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-6 mb-24">
          ...
          <div className="md:col-span-12 lg:col-span-8 bg-gray-900 rounded-[3rem] p-10 flex flex-col justify-between relative overflow-hidden group border border-white/5 order-2 lg:order-1">
            ...
            <div className="relative z-10">
              <div className="flex items-center gap-4 mb-8">
                <div className="w-16 h-16 rounded-2xl bg-vive-500 flex items-center justify-center text-black">
                  <FaRoute className="w-8 h-8" />
                </div>
                <div>
                  <div className="text-white font-black text-3xl tracking-tighter">Cobertura Total</div>
                  <div className="text-vive-500/60 text-[10px] uppercase tracking-widest font-bold">Sin Fronteras en el Territorio Nacional</div>
                </div>
              </div>
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mt-12">
                {provinces.slice(0, 12).map((city, idx) => (
                  <div key={idx} className="flex items-center gap-3 text-gray-400 group/city cursor-default">
                    <div className="w-1.5 h-1.5 rounded-full bg-vive-500 group-hover/city:scale-150 transition-transform"></div>
            ...
            <div className="relative z-10 mt-12 pt-10 border-t border-white/5 flex flex-col md:flex-row items-center justify-between gap-6">
              ...
              <div className="flex -space-x-3">
                <div className="w-12 h-12 rounded-full border-2 border-gray-900 bg-gray-800 flex items-center justify-center text-vive-500" title="Terrestre"><FaTruck /></div>
                <div className="w-12 h-12 rounded-full border-2 border-gray-900 bg-gray-800 flex items-center justify-center text-vive-500" title="Marítimo"><FaShip /></div>
                <div className="w-12 h-12 rounded-full border-2 border-gray-900 bg-gray-800 flex items-center justify-center text-vive-500" title="Aéreo"><FaPlane /></div>
              </div>
            </div>
          </div>

          {/* Delivery Time Card - Vertical High Impact */}
          <div className="md:col-span-12 lg:col-span-4 bg-vive-500 rounded-[3rem] p-10 flex flex-col items-center justify-center text-center relative overflow-hidden group shadow-2xl shadow-vive-500/10 order-1 lg:order-2">
          ...
          {/* Small Feature Cards */}
          <div className="md:col-span-6 lg:col-span-3 bg-gray-50 dark:bg-white/5 rounded-[2.5rem] p-8 border border-gray-100 dark:border-white/5 hover:border-vive-500/30 transition-all duration-500 group order-3">
            <FaTruck className="w-10 h-10 text-vive-500 mb-6 group-hover:scale-110 transition-transform" />
          ...
          <div className="md:col-span-6 lg:col-span-3 bg-gray-50 dark:bg-white/5 rounded-[2.5rem] p-8 border border-gray-100 dark:border-white/5 hover:border-vive-500/30 transition-all duration-500 group order-4">
            <FaBox className="w-10 h-10 text-vive-500 mb-6 group-hover:scale-110 transition-transform" />
          ...
          <div className="md:col-span-6 lg:col-span-3 bg-gray-50 dark:bg-white/5 rounded-[2.5rem] p-8 border border-gray-100 dark:border-white/5 hover:border-vive-500/30 transition-all duration-500 group order-5">
            <FaRoute className="w-10 h-10 text-vive-500 mb-6 group-hover:scale-110 transition-transform" />
          ...
          <div className="md:col-span-6 lg:col-span-3 bg-gray-50 dark:bg-white/5 rounded-[2.5rem] p-8 border border-gray-100 dark:border-white/5 hover:border-vive-500/30 transition-all duration-500 group order-6">
            <FaCheckCircle className="w-10 h-10 text-vive-500 mb-6 group-hover:scale-110 transition-transform" />
        ...
        <div className="relative bg-gray-900 rounded-[4rem] p-10 lg:p-20 overflow-hidden group">
          ...
          <div className="relative z-10 max-w-2xl">
            <h3 className="text-3xl lg:text-5xl font-black text-white uppercase tracking-tighter leading-[0.9] mb-8">
              ¿No ves tu ciudad? <br />
              <span className="text-vive-500">¡Llegamos igual!</span>
            </h3>
            <p className="text-gray-400 text-lg font-medium mb-12 leading-relaxed">
              Si tu ubicación no está en la lista estándar, nuestro equipo de logística diseñará una ruta especial para que recibas tu Vive.
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-6">
              <a
                ...
                className="bg-vive-500 hover:bg-vive-600 text-white px-10 py-5 rounded-full font-black text-sm uppercase tracking-widest transition-all hover:scale-105 shadow-2xl shadow-vive-500/20 flex items-center justify-center gap-3"
              >
