      ...
      <div className="relative container mx-auto px-6 lg:px-20 py-24 lg:py-32">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold font-display leading-tight mb-6">
            ...
            <span className="block text-gold-400 mt-2">Perú</span>
          </h1>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            <Link
              to="/catalogo"
              className="group inline-flex items-center gap-3 bg-gold-500 hover:bg-gold-600 text-white px-8 py-4 rounded-lg font-bold text-lg transition-all hover:scale-105 shadow-xl"
            >
              Comprar ahora
            ...
            <a
              ...
              className="group inline-flex items-center gap-3 bg-transparent border-2 border-gold-400 text-gold-400 hover:bg-gold-400 hover:text-gray-900 px-8 py-4 rounded-lg font-bold text-lg transition-all"
            >
              Cotizar por mayor
              <FaArrowRight className="w-5 h-5 group-hover:translate-x-1 transition-transform" />
            </a>
