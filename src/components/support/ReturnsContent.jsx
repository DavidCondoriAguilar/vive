    ...
    <div className="space-y-6 text-sm text-left">
        <section>
            ...
            <ul className="space-y-3 text-gray-600 dark:text-gray-400">
                <li className="flex gap-3"><span className="text-vive-500 font-bold">01.</span> Tiene hasta <strong>7 días calendario</strong> para solicitar un cambio por defecto de fabricación.</li>
                <li className="flex gap-3"><span className="text-vive-500 font-bold">02.</span> El producto debe estar <strong>completamente nuevo</strong>, con embalaje original y etiquetas intactas.</li>
                <li className="flex gap-3"><span className="text-vive-500 font-bold">03.</span> Presentar el comprobante de pago original (Boleta o Factura).</li>
            </ul>
        </section>
