...
const NavActions = ({ toggleMobileMenu, isMobileMenuOpen, waLink }) => {
    ...
    return (
        <div className="flex items-center gap-1 sm:gap-2.5 lg:gap-4 ml-auto flex-shrink-0">
            ...
            <button
                onClick={toggleTheme}
                className="w-10 h-10 flex items-center justify-center rounded-xl text-gray-500 hover:text-gold-500 hover:bg-gray-50 dark:hover:bg-white/5 transition-all duration-300"
                aria-label="Cambiar tema"
            >
                {theme === 'light' ? (
                    <MdOutlineDarkMode className="w-5 h-5 sm:w-6 sm:h-6" />
                ) : (
                    <MdOutlineLightMode className="w-5 h-5 sm:w-6 sm:h-6" />
                )}
            </button>
            ...
            <button
                ...
                className="relative group w-11 h-11 flex items-center justify-center rounded-xl text-gray-700 hover:text-gold-500 hover:bg-gray-50 dark:hover:bg-white/5 transition-all duration-300 flex-shrink-0"
            ...
            <a
                ...
                className="hidden sm:flex items-center gap-2.5 bg-gray-900 dark:bg-white text-white dark:text-gray-900 px-6 py-3.5 rounded-xl font-brand font-black text-[11px] uppercase tracking-[0.2em] transition-all hover:bg-gold-500 dark:hover:bg-gold-500 hover:text-white dark:hover:text-white hover:scale-105 shadow-xl shadow-black/5 active:scale-95"
            >
            ...
            <button
                ...
                className="lg:hidden w-11 h-11 flex items-center justify-center rounded-xl bg-gray-900 dark:bg-white text-white dark:text-gray-900 hover:bg-black dark:hover:bg-gray-100 transition-all active:scale-95 flex-shrink-0"
                aria-label="Menú"
