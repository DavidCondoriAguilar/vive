...
const NavActions = ({ toggleMobileMenu, isMobileMenuOpen, waLink }) => {
    ...
    return (
        <div className="flex items-center gap-1 sm:gap-2.5 lg:gap-4 ml-auto flex-shrink-0">
            ...
            {/* WhatsApp Button - Desktop Only - Optimized */}
            <a
                href={waLink}
                target="_blank"
                rel="noopener noreferrer"
                className="hidden lg:flex items-center gap-2 bg-gray-900 dark:bg-white text-white dark:text-gray-900 px-4 py-2.5 rounded-lg font-brand font-black text-[10px] uppercase tracking-[0.2em] transition-all hover:bg-gold-500 dark:hover:bg-gold-500 hover:text-white dark:hover:text-white hover:scale-105 shadow-lg active:scale-95"
            >
