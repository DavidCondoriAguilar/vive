  ...
  return (
    <div className="flex flex-col lg:flex-row lg:items-end justify-between mb-16 gap-12">
      <div className="max-w-xl">
        ...
        <h2 className="text-4xl lg:text-[65px] font-display font-black text-gray-900 dark:text-white uppercase leading-[0.85] tracking-tighter mb-10">
          {title}
        </h2>
        <div className="flex items-center gap-4 mb-4">
          <div className="flex-1 h-[1px] bg-gray-100 dark:bg-white/10 rounded-full overflow-hidden">
            <div
              className="h-full bg-vive-500 shadow-[0_0_10px_#299C47]"
